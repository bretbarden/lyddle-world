...
function About (){
    ...
    return(
        <div>
            ...
            <p>At Lyddle World, we use AI technology to make reading dynamic, exciting, and fun for your child. With our app, you can make endless stories, customized specifcally for your Lyddle One, so that they never get bored and stay engaged with stories specifically about them and their own Lyddle World. </p>
